...
\item Интегрируемость композиции непрерывной и интегрируемой функций - \textbf{много недочётов!}
\item \sout{Интегрируемость произведения функций}
...
\item \sout{Вычисление длины дуги}
\item \sout{Приближённое вычисление интеграла: методы прямоугольников, трапеций, Симпсона} 
\end{enumerate}
